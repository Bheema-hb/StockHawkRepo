...
public final class QuoteSyncJob {
    ...
    public static final String ACTION_STOCK_HISTORY = "com.udacity.stockhawk.STOCK_HISTROY";
    ...
    public static Stock getHistory(String symbol, Context applicationContext) {
